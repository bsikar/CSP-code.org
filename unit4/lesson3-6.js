...
console.log("This
        one string prints on multiple lines ");
        ...
        console.log("Hi there!
            ...
            console.log("How many weeks have you been alive?"); console.log("I've been alive about " + (age * 52) + " weeks!
                ");
                ...
                to add spaces to your output.console.log("I have been alive for " + (age * 365) + " days"); console.log("How many months have you been alive?");
